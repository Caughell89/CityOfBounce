...
public class EmailTemplates {
    ...
    String newFooter
            ...
            + "Connect with us"
            + "</p>"
            + "<a href='https://www.facebook.com/cityofbounce' style='text-decoration:none;font-size:16px;margin:8px; height:12px; width;auto;'><img src='https://res.cloudinary.com/city-of-bounce/image/upload/v1600184987/facebook.png' alt='facebook link'  style='border:0;'></a>"
            + "<a href='https://twitter.com/CityOfBounce' style='text-decoration:none;font-size:16px;margin:8px;height:12px; width;auto;'><img src='https://res.cloudinary.com/city-of-bounce/image/upload/v1600184952/twitter.png' alt='twitter link'  style='border:0;'></a>"
            + "<a href='https://www.instagram.com/cityofbounce' style='text-decoration:none;font-size:16px;margin:8px;height:12px; width;auto;'><img src='https://res.cloudinary.com/city-of-bounce/image/upload/v1600184974/instagram.png' alt='instagram link' style='border:0;'></a>"
            + "</td>"
            + "</tr>"
            + "</table>"
            + "</td>"
