...
public class EmailTemplates {
    ...
    String newFooter
            ...
            + "Connect with us"
            + "</p>"
            + "<a href='https://www.facebook.com/cityofbounce' style='text-decoration:none;font-size:16px;margin:8px; height:12px; width;auto;'><img src='https://res.cloudinary.com/city-of-bounce/image/upload/v1600184987/facebook-brands-16.png' alt='facebook link'  style='border:0;'></a>"
            + "<a href='https://twitter.com/CityOfBounce' style='text-decoration:none;font-size:16px;margin:8px;height:12px; width;auto;'><img src='https://res.cloudinary.com/city-of-bounce/image/upload/v1600184952/twitter-brands-16.png' alt='twitter link'  style='border:0;'></a>"
            + "<a href='https://www.instagram.com/cityofbounce' style='text-decoration:none;font-size:16px;margin:8px;height:12px; width;auto;'><img src='https://res.cloudinary.com/city-of-bounce/image/upload/v1600184974/instagram-brands-16.png' alt='instagram link' style='border:0;'></a>"
            + "</td>"
            + "</tr>"
            + "</table>"
            + "</td>"
            ...
            + "</p>"
            + "<p style='font-size: 10px; margin-bottom: 2px; margin-top: 0px;'>"
